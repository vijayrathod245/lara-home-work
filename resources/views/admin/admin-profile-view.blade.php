                                                ...
                                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                                    <div class="flex-shrink-0">
                                                        <div class="avatar-xl me-3">
                                                            <img src="{{ (!empty($adminData->profile_photo_path)) ? url('upload/admin-images/'.$adminData->profile_photo_path): url('upload/avatar-1.jpg') }}" alt="" class="img-fluid rounded-circle d-block">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div>
                                                            <h5 class="font-size-16 mb-1">{{ $adminData->name }}</h5>
                                                            ...
                                                            <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
                                                                ...
                                                                <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>{{ $adminData->email }}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-4">
                                                            <div class="card p-1 mb-xl-0">
                                                                ...
                                                                <div class="position-relative">
                                                                    <img src="{{ asset('assets/images/small/img-3.jpg') }}" alt="" class="img-thumbnail">
                                                                </div>
                                                        ...
                                                        <div class="col-xl-4">
                                                            <div class="card p-1 mb-xl-0">
                                                                ...
                                                                <div class="position-relative">
                                                                    <img src="{{ asset('assets/images/small/img-1.jpg') }}" alt="" class="img-thumbnail">
                                                                </div>
                                                        ...
                                                        <div class="col-xl-4">
                                                            <div class="card p-1 mb-sm-0">
                                                                ...
                                                                <div class="position-relative">
                                                                    <img src="{{ asset('assets/images/small/img-5.jpg') }}" alt="" class="img-thumbnail">
                                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="list-group list-group-flush">
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm flex-shrink-0 me-3">
                                                        <img src="{{ asset('assets/images/users/avatar-3.jpg') }}" alt="" class="img-thumbnail rounded-circle">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div>
