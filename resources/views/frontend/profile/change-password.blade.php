    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2"></br>
                <img class="card-img-top" style="border-radius:50%;" src="{{ (!empty($user->profile_photo_path)) ? url('upload/user-images/'.$user->profile_photo_path): url('upload/avtar-1.jpg') }}" height="100%" width="100%" />
                </br></br>
