            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                        ...
                        <div data-simplebar style="max-height: 230px;">
                            ...
                            <a href="#!" class="text-reset notification-item">
                                <div class="d-flex">
                                    <img src="{{ asset('assets/images/users/avatar-6.jpg') }}" class="me-3 rounded-circle avatar-sm" alt="user-pic">
                                    <div class="flex-grow-1">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item bg-soft-light border-start border-end" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" src="{{ (!empty($adminData->profile_photo_path)) ? url('upload/admin-images/'.$adminData->profile_photo_path): url('upload/avatar-1.jpg') }}" alt="Header Avatar">
                        <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ $adminData->name }}</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('admin.change.password') }}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Change Password</a>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button">
                                <i data-feather="grid"></i><span data-key="t-apps">Brands</span>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-pages">

                                <a href="{{ route('all.brand') }}" class="dropdown-item" data-key="t-calendar">List Brand</a>
                                <a href="{{ route('add.brand') }}" class="dropdown-item" data-key="t-chat">Add Brand</a>
                            </div>
                        </li>

                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button">
                                <i data-feather="grid"></i><span data-key="t-apps">Categories</span>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                ...
                                <a href="{{ route('add.subsubcategory') }}" class="dropdown-item" data-key="add-sub-sub-category">Add SubSubCategory</a>
                            </div>
                        </li>
                        
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="product-pages" role="button">
                                <i data-feather="grid"></i><span data-key="products">Products</span>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="product-pages">

                                <a href="{{ route('add-product') }}" class="dropdown-item" data-key="add-product">Add Products</a>
                                <a href="#" class="dropdown-item" data-key="manage-product">Manage Products</a>
